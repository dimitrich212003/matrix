...
public class Main {
    ...
    public static void main(String[] args) {
        DeterminantCalculator threadedCalculator = new ThreadedCalculator(matrix, 11);
        DeterminantCalculator calculator = new Calculator(matrix);

        long startTimeThreaded = System.currentTimeMillis();
        System.out.println("Результат рекурсивного параллелизма: " + threadedCalculator.calculateDeterminant());
        long endTimeThreaded = System.currentTimeMillis();
        System.out.printf("%s миллисекунд\n", endTimeThreaded - startTimeThreaded);


        long startTime = System.currentTimeMillis();
        System.out.println("Результат однопоточного алгоритма: " + calculator.calculateDeterminant());
        ...
        DeterminantCalculator testThreadedCalculator = new ThreadedCalculator(matrix, 11);
